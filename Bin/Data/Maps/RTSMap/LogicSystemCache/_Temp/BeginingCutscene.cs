...
{
	public class BeginingCutscene : Engine.EntitySystem.LogicSystem.LogicEntityObject
	{
		Engine.MapSystem.Region __ownerEntity;
		
		public BeginingCutscene( Engine.MapSystem.Region ownerEntity )
			: base( ownerEntity )
		{
		...
		{
			Engine.EntitySystem.LogicClass __class = Engine.EntitySystem.LogicSystemManager.Instance.MapClassManager.GetByName( "BeginingCutscene" );
